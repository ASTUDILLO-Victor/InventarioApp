...
Console.WriteLine("Comandos: listar, agregar, eliminar, salir");
Console.WriteLine();
while (sistemaActivo)
{
    ...
    string comando = entradaDos?.Trim().ToLower() ?? "salir";
    switch (comando)
    {
        case "listar":
            Console.WriteLine($"Productos en inventario: {contidadProductos}");
            break;
        case "agregar":
        ...
        default:
            ...
            Console.WriteLine("Comandos disponibles: listar, agregar, eliminar, salir");
            break;
    }
