...
public class JsonInventarioStorage
{
    ...
    /// </summary>
    public void Guardar(List<Productos> productos, string ruta)
    {
    ...
    /// </summary>
    public List<Productos> Cargar(string ruta)
    {
        ...
        return JsonSerializer.Deserialize<List<Productos>>(json, _options)
               ?? new List<Productos>();
    }
